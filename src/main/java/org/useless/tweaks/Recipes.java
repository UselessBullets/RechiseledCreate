...
import static org.useless.tweaks.UselessTweaks.CREATE_REGISTRATION;
import static org.useless.tweaks.UselessTweaks.RECHISELED_REGISTRATION;
...
public class Recipes {
    ...
    private static ResourceLocation location(String name){
        return new ResourceLocation(UselessTweaks.MODID, name);
    }
    ...
    public static void chiselRecipes() {
        // MW Tile conversions
    ...
    private static void regularBlockOnly(ResourceLocation recipe, Supplier<ItemLike> block){
        RECHISELED_REGISTRATION.chiselingEntry(recipe, entry -> entry.regularBlock(block.get()));
    }
    ...
    private static void connectingBlockOnly(ResourceLocation recipe, Supplier<ItemLike> block){
        RECHISELED_REGISTRATION.chiselingEntry(recipe, entry -> entry.connectingBlock(block.get()));
    }
    ...
    private static void regularSet(ResourceLocation recipe, String blockIdentifier, String stairsIdentifier, String slabIdentifier){
        ...
        RECHISELED_REGISTRATION.chiselingEntry(recipe, entry -> {
