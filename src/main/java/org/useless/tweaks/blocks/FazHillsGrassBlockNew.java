package org.useless.tweaks.blocks;
...
public class FazHillsGrassBlockNew extends GrassBlock {
    private final Supplier<Block> dirt;
    public FazHillsGrassBlockNew(Properties p_53685_, Supplier<Block> dirt) {
        super(p_53685_);
        this.dirt = dirt;
    }
    ...
    public void randomTick(BlockState p_222508_, ServerLevel p_222509_, BlockPos p_222510_, RandomSource p_222511_) {
        if (!canBeGrass(p_222508_, p_222509_, p_222510_)) {
            ...
            p_222509_.setBlockAndUpdate(p_222510_, this.dirt.get().defaultBlockState());
        } else {
